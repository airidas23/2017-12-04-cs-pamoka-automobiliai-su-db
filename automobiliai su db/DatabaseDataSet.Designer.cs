...
namespace automobiliai_su_db {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CarsRow AddCarsRow(int Id, string Make, string Model, int Year, int Milage) {
        ...
        public partial class CarsRow : global::System.Data.DataRow {
            ...
            public int Milage {
                get {
                    return ((int)(this[this.tableCars.MilageColumn]));
                }
                set {
                    this[this.tableCars.MilageColumn] = value;
                }
            }
        }
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cars] WHERE (([Id] = @Original_Id) AND ([Make] = @Original_Mak" +
                "e) AND ([Model] = @Original_Model) AND ([Year] = @Original_Year) AND ([Milage] =" +
                " @Original_Milage))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([Id], [Make], [Model], [Year], [Milage]) VALUES (@Id, @" +
                "Make, @Model, @Year, @Milage);\r\nSELECT Id, Make, Model, Year, Milage FROM Cars W" +
                "HERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [Id] = @Id, [Make] = @Make, [Model] = @Model, [Year] = @Year, [Milage] = @Milage WHERE (([Id] = @Original_Id) AND ([Make] = @Original_Make) AND ([Model] = @Original_Model) AND ([Year] = @Original_Year) AND ([Milage] = @Original_Milage));
SELECT Id, Make, Model, Year, Milage FROM Cars WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Make, Model, Year, Milage FROM dbo.Cars";
        ...
        public virtual int Delete(int Original_Id, string Original_Make, string Original_Model, int Original_Year, int Original_Milage) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_Milage));
        ...
        public virtual int Insert(int Id, string Make, string Model, int Year, int Milage) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(Milage));
        ...
        public virtual int Update(int Id, string Make, string Model, int Year, int Milage, int Original_Id, string Original_Make, string Original_Model, int Original_Year, int Original_Milage) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Milage));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Milage));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Make, string Model, int Year, int Milage, int Original_Id, string Original_Make, string Original_Model, int Original_Year, int Original_Milage) {
            return this.Update(Original_Id, Make, Model, Year, Milage, Original_Id, Original_Make, Original_Model, Original_Year, Original_Milage);
        }
    }
